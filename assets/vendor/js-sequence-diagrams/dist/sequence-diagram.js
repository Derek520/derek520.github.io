...
// TODO Move defintion of fonts onto the <svg>, so it can easily be override at each level
  ...
  _.extend(SnapTheme.prototype, BaseTheme.prototype, {
    ...
    waitForFont: function(callback) {
      ...
      WebFont.load({
          ...
          inactive: function() {
              // If we fail to fetch the fonts, still continue.
              LOADED_FONTS[fontFamily] = true;
              callback();
            }
        });
...
if (typeof Raphael != 'undefined') {
  ...
  _.extend(RaphaelTheme.prototype, BaseTheme.prototype, {
    ...
    drawText: function(x, y, text, font, align) {
      ...
      var t;
      if (font.obj_) {
        // When using a fonts, we have to use .print(..)
 ...
 * 
 * Trademark:
 * Please refer to the Copyright section for the fonts trademark attribution
 * notices.
 * 
 * Full name:
 * Daniel-Bold
 * 
 * Description:
 * Daniel Bold is a fonts by Daniel Midgley.
 * 
 * Designer:
 * Daniel Midgley
 * 
